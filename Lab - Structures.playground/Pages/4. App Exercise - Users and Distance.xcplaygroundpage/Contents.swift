 ...
 */
var user1 = User(name: "Kimball", age: 36, height: 65, weight: 238.1, activityLevel: 5)
print(user1)
 ...
 */
var footballField = Distance(feet: 360)
print(footballField.meters)
print(footballField.feet)
